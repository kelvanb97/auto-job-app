...
| Export                   | Description                                                                                                                                                                                                                                                                                                           |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `createBrowserContext()` | Launch a persistent Chrome context. The user-data dir lives at `<workspace_root>/data/chrome-profile` (gitignored), discovered by walking up from `process.cwd()` to the nearest `pnpm-workspace.yaml`. Viewport 1280x900, locale `en-US`, timezone `America/Los_Angeles`. Accepts optional `{ headless?: boolean }`. |
